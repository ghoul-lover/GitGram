...
def start(_bot, update):
    ...
    message.reply_text(
        f"This is the Updates watcher for {PROJECT_NAME}. HI i will update changes in hikigaya",
        parse_mode="markdown")
...
def support(_bot, update):
    ...
    message = update.effective_message
    message.reply_text(
        f"*Getting Support*\n\nTo get support in using the bot, join [the GitGram support](https://t.me/hikigayasupport).",
        parse_mode="markdown"
    )
